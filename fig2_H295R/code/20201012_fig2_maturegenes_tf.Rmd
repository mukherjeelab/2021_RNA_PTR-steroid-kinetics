---
title: "20201012 PTR steroidogenesis paper: figure 2 heatmap mature genes with transcription factors"
author: "Kim Wellman"
date: '20201012'
output:
  html_document:
...
keygenes <- c("AGTR1", "MC2R", "CREB1", "NR0B1", "NR5A1", "STAR","NR4A2", "NR4A1", "NR2F1", "CYP11B2")
...
pheatmap(ave_keygenes_norm, breaks = seq(-range, range, length.out = 100), cluster_cols = F, cluster_rows = F, gaps_row = c(3,6), main = "Normalized mature RNA levels for transcription factors in aldosterone production", angle_col = c("0"), color = rev(colorRampPalette(brewer.pal(n = 5, name = "RdBu"))(100)))
