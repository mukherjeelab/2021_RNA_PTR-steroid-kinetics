...
my.contrasts <- makeContrasts(
  ...
  Avsb.6 = AngII.6-basal.6,
  Avsb.12 = AngII.12-basal.12,
  Avsb.24 = AngII.24-basal.24,
  Avsb.48 = AngII.48-basal.48,
levels = design)
...
my.contrasts <- makeContrasts(
  ...
  Avsb.6 = ACTH.6-basal.6,
  Avsb.12 = ACTH.12-basal.12,
  Avsb.24 = ACTH.24-basal.24,
  Avsb.48 = ACTH.48-basal.48,
levels = design)
qlf <- glmQLFTest(fit, contrast = my.contrasts)
res <- topTags(qlf, n = 100000000)$table
res_A <- res %>% rownames_to_column("gene_id") %>%
...
write_csv(res_a, here("data", "RNAseq", "edger_AngIIvsbasal.csv.gz"))
write_csv(res_A, here("data", "RNAseq", "edger_ACTHvsbasal.csv.gz"))
```
...
write_tsv(res_a2, here("data", "RNAseq", "AngIIvsbasal_pertimepoint.tsv"))
write_tsv(res_A2, here("data", "RNAseq", "ACTHvsbasal_pertimepoint.tsv"))
```